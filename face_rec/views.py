...
def index(request):
	if request.method=="POST" and request.POST.get('face')=='face':
		...
		# }
	elif request.method=="POST" and request.POST.get('Employee Count')=='Employee Count':
		recognition.rec()
		return render(request,'home.html')
	...
	# 	empTrainer.train()
	# 	return render(request,'home.html')
	elif request.method=="POST" and request.POST.get('Start Foot Count')=='Start Foot Count':
		footfall.count()
		return render(request,'home.html')
	else:
